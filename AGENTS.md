...
Phase 2A is a bilingual harvest-planning and grape-intake frontend checkpoint with versioned local persistence. Authentication and shared Catalyst persistence remain deferred. See `PHASES.md`.
