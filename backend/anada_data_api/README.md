...
Phase 3B.1 Advanced I/O function source. It performs a read-only availability check against the seven Añada Data Store tables and exposes `GET /health`. It deliberately exposes no operational records and accepts no mutations.
